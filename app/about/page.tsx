			...
			<main className="flex flex-col gap-8">
				<div className="flex flex-col gap-8 h-32 md:h-40">
					...
					<p className="font-sans text-sm md:text-lg text-zinc-500 text-pretty">
						...
						<CustomLink href="https://en.wikipedia.org/wiki/Milan" target="_blank">
							Milan
						</CustomLink>
				...
				<div className="flex flex-col gap-12 md:gap-18">
					<div className="flex flex-col">
						...
						<p className="font-sans text-sm md:text-lg text-zinc-500 text-pretty pt-2">
							Raised in{" "}
							<CustomLink href="https://en.wikipedia.org/wiki/Cervia" target="_blank">
								Cervia
							</CustomLink>
				...
				<section className="w-full flex flex-col items-start justify-center text-start pt-6 gap-3 md:gap-8">
					...
					<div className="w-full h-full flex flex-col pt-2 gap-2">
						<ExperienceCard
							...
							description={
								<>
									Currently working as a UX Design and Creative Coding intern at{" "}
									<CustomLink href="https://www.accurat.it" target="_blank">
										Accurat
									</CustomLink>
									. Immersed in a vibrant and easygoing environment, I'm helping
									build web and&nbsp;mobile experiences. My work focuses mainly
									on data visualization, seamlessly blending design
									with&nbsp;code.
								</>
							}
						/>
						...
						<ExperienceCard
							...
							description={
								<>
									Studied{" "}
									<CustomLink href="https://www.polimi.it/formazione/corsi-di-laurea/dettaglio-corso/design-della-comunicazione" target="_blank">
									...
									<CustomLink href="https://www.polimi.it/en/education/laurea-magistrale-programmes/programme-detail/digital-and-interaction-design" target="_blank">
						...
						<ExperienceCard
							...
							description={
								<>
									...
									working at&nbsp;
									<CustomLink href="https://www.copysystem.net/azienda/" target="_blank">
										CopySystem
									</CustomLink>
						...
						<ExperienceCard
							...
							description={
								<>
									...
									<CustomLink href="https://www.ispascalcomandini.it/itt-b-pascal/" target="_blank">
										ITT&nbsp;Blaise&nbsp;Pascal
									</CustomLink>
									...
									<CustomLink href="https://dotnet.microsoft.com/it-it/languages/csharp" target="_blank">
										C#
									</CustomLink>
									,{" "}
									<CustomLink href="https://isocpp.org/tour" target="_blank">
										C++
									</CustomLink>
									,{" "}
									<CustomLink href="https://www.mysql.com" target="_blank">
										MySQL
									</CustomLink>{" "}
									and&nbsp;
									<CustomLink href="https://kotlinlang.org" target="_blank">
										Kotlin
									</CustomLink>
									.
								</>
				...
				<section className="w-full flex flex-col items-start justify-center text-start pt-6 gap-3 md:gap-8">
					...
					<div className="flex flex-col font-sans text-sm md:text-lg text-zinc-500 gap-0.5">
						<div className="flex flex-row gap-1 items-center align-middle">
							...
							<CustomLink href="mailto:ciao@filippoalessandrini.com">
						...
						<div className="flex flex-row gap-1 items-center align-middle">
							...
							<CustomLink href="https://www.instagram.com/_filippoalessandrini_" target="_blank">
